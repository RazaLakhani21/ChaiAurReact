...
function App() {
  ...
  let [counter, setCounter] = useState(15) //on 0th index the value could be anything 'counter' or 'SuperMan' and on the 1st index it is Function. and because of name-Convention we've put the name 'setCounter' not necessary, it could be 
